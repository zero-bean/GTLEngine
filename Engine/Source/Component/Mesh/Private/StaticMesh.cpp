...
// Triangle BVH helpers moved to Core/Public/TriangleBVH.h and Core/Private/TriangleBVH.cpp
...
void UStaticMesh::EnsureTriangleBVH() const
{
    ...
    FTriangleBVH::Build(
        StaticMeshAsset->Vertices,
        StaticMeshAsset->Indices,
        StaticMeshAsset->TriangleBVHPrimitives,
        StaticMeshAsset->TriangleBVHNodes,
        StaticMeshAsset->TriangleBVHRoot);
