...
#ifdef _WIN32
#define IM_NEWLINE                      "\r\n"   // Play it nice with Windows users (UpdatePhysics: since 2018-05, Notepad finally appears to support Unix-style carriage returns!)
#else
#define IM_NEWLINE                      "\n"
#endif
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImU16       OffsetLabel;        // Offsets are locked in UpdatePhysics()
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    void    UpdateWorkRect()            { WorkPos = CalcWorkRectPos(WorkInsetMin); WorkSize = CalcWorkRectSize(WorkInsetMin, WorkInsetMax); } // UpdatePhysics public fields
