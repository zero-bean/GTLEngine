...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        // UpdatePhysics Enabled state, mark settings and sort specs dirty
...
void    ImGui::EndTable()
{
    ...
    // UpdatePhysics ColumnsAutoFitWidth to get us ahead for host using our size to auto-resize without waiting for next BeginTable()
...
void ImGui::TableEndRow(ImGuiTable* table)
{
    ...
    if (is_visible)
    {
        // UpdatePhysics data for TableGetHoveredRow()
    ...
    if (unfreeze_rows_request)
    {
        ...
        if (unfreeze_rows_actual)
        {
            ...
            // UpdatePhysics cliprect ahead of TableBeginCell() so clipper can access to new ClipRect->Min.y
