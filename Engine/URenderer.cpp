...
void URenderer::SubmitBillboardSprite(const FVector& AnchorWorld, float SizeX, float SizeY, const FSlicedUV& UV)
{
	...
	SubmitSprite(M, baseXY, sizeXY, UV, /*z=*/0.0f, /*pivot=*/FVector(0, 0, 0));
}