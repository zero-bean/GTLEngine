...
IMPLEMENT_CLASS(UDynamicAmbientProbe)

UDynamicAmbientProbe::UDynamicAmbientProbe()
{
    bCanEverTick = true;
...
void UDynamicAmbientProbe::Serialize(bool bIsLoading, FComponentData& InOut)
{
    ...
    if (bIsLoading)
    {
        ...
        // Implementation depends on your serialization system
    }
    else
    {
        // Save probe settings
...
void UDynamicAmbientProbe::SetCaptureResolution(int32 InResolution)
{
...
void UDynamicAmbientProbe::ForceCapture()
{
...
void UDynamicAmbientProbe::ReleaseCubemapTargets()
{
    for (int32 i = 0; i < 6; ++i)
    {
...
void UDynamicAmbientProbe::CaptureEnvironment(UWorld* World, URenderer* Renderer)
{
    if (!bIsInitialized)
        return;
...
void UDynamicAmbientProbe::ProjectToSH()
{
    if (!bIsInitialized)
        return;
...
void UDynamicAmbientProbe::SmoothSH()
{
...
FMatrix UDynamicAmbientProbe::GetCubeFaceViewMatrix(ECubeFace Face) const
{
...
FMatrix UDynamicAmbientProbe::GetCubeFaceProjectionMatrix() const
{
...
FVector UDynamicAmbientProbe::CubeUVToDir(ECubeFace Face, float U, float V)
{
...
float UDynamicAmbientProbe::TexelSolidAngle(int32 X, int32 Y, int32 Size)
{
...
float UDynamicAmbientProbe::SHBasis(int32 Index, const FVector& Dir)
{
