...
void UImGuiHelper::SetupCustomTheme()
{
	...
	// ===== 색상 팔레트 (Neutral Gray Dark Theme) =====
	ImVec4* Colors = Style.Colors;

	// 배경 색상 (부드러운 다크 그레이)
	Colors[ImGuiCol_WindowBg] = ImVec4(0.09f, 0.09f, 0.09f, 1.00f); // 메인 윈도우 배경
	Colors[ImGuiCol_ChildBg] = ImVec4(0.11f, 0.11f, 0.11f, 1.00f); // 자식 윈도우 배경
	Colors[ImGuiCol_PopupBg] = ImVec4(0.10f, 0.10f, 0.10f, 0.98f); // 팝업 배경
	...
	// 프레임 배경 (입력 필드, 콤보박스 등)
	Colors[ImGuiCol_FrameBg] = ImVec4(0.16f, 0.16f, 0.16f, 1.00f); // 기본
	Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.22f, 0.22f, 0.22f, 1.00f); // 오버
	Colors[ImGuiCol_FrameBgActive] = ImVec4(0.26f, 0.26f, 0.26f, 1.00f); // 활성

	// 타이틀바
	Colors[ImGuiCol_TitleBg] = ImVec4(0.06f, 0.06f, 0.06f, 1.00f); // 비활성
	Colors[ImGuiCol_TitleBgActive] = ImVec4(0.12f, 0.12f, 0.12f, 1.00f); // 활성
	Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.06f, 0.06f, 0.06f, 0.75f); // 접힌 상태
	...
	// 버튼
	Colors[ImGuiCol_Button] = ImVec4(0.20f, 0.20f, 0.20f, 0.85f); // 기본
	Colors[ImGuiCol_ButtonHovered] = ImVec4(0.32f, 0.32f, 0.32f, 0.90f); // 오버
	Colors[ImGuiCol_ButtonActive] = ImVec4(0.40f, 0.40f, 0.40f, 1.00f); // 클릭

	// 헤더 (트리 노드, 콤보박스 등)
	Colors[ImGuiCol_Header] = ImVec4(0.20f, 0.20f, 0.20f, 0.80f);
	Colors[ImGuiCol_HeaderHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.90f);
	Colors[ImGuiCol_HeaderActive] = ImVec4(0.40f, 0.40f, 0.40f, 1.00f);

	// 분리선
	Colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.28f, 0.28f, 0.70f);
	Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.50f, 0.50f, 0.50f, 0.90f);
	...
	// 탭
	Colors[ImGuiCol_Tab] = ImVec4(0.12f, 0.12f, 0.12f, 1.00f); // 비활성
	Colors[ImGuiCol_TabHovered] = ImVec4(0.30f, 0.30f, 0.30f, 0.90f); // 오버
	Colors[ImGuiCol_TabActive] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f); // 활성
	...
	Colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.25f, 0.25f, 0.25f, 0.08f);

	// 텍스트 선택
	Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.60f, 0.60f, 0.60f, 0.35f);

	// 드래그 앤 드롭 타겟
	Colors[ImGuiCol_DragDropTarget] = ImVec4(0.90f, 0.90f, 0.90f, 0.90f);
