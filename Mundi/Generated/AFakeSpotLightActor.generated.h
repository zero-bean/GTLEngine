...
#define A_FAKE_SPOT_LIGHT_ACTOR_BODY \
public: \
    using Super = AActor; \
    using ThisClass_t = AFakeSpotLightActor; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "AFakeSpotLightActor", AActor::StaticClass(), sizeof(AFakeSpotLightActor) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return AFakeSpotLightActor::StaticClass(); } \
    AFakeSpotLightActor(const AFakeSpotLightActor&) = default; \
    AFakeSpotLightActor* Duplicate() const override \
    { \
        AFakeSpotLightActor* NewObject = ObjectFactory::DuplicateObject<AFakeSpotLightActor>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY A_FAKE_SPOT_LIGHT_ACTOR_BODY
