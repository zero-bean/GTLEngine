...
FAnimationViewerViewportClient::FAnimationViewerViewportClient()
{
...
void FAnimationViewerViewportClient::Draw(FViewport* Viewport)
{
...
void FAnimationViewerViewportClient::Tick(float DeltaTime)
{
    // Reuse base behavior (camera input, wheel, clipboard shortcuts)
    FViewportClient::Tick(DeltaTime);
}

void FAnimationViewerViewportClient::MouseMove(FViewport* Viewport, int32 X, int32 Y)
{
    FViewportClient::MouseMove(Viewport, X, Y);
}

void FAnimationViewerViewportClient::MouseButtonDown(FViewport* Viewport, int32 X, int32 Y, int32 Button)
{
    FViewportClient::MouseButtonDown(Viewport, X, Y, Button);
}

void FAnimationViewerViewportClient::MouseButtonUp(FViewport* Viewport, int32 X, int32 Y, int32 Button)
{
    FViewportClient::MouseButtonUp(Viewport, X, Y, Button);
}

void FAnimationViewerViewportClient::MouseWheel(float DeltaSeconds)
{
